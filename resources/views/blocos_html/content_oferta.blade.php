    ...
    <div class="card shadow-sm" id="card-video">
        <div class="card-body ">
            ...
            <video class="w-100 rounded" controls>
                <source src="@if($havePermissionToWatchPitch || $myprofile){{ asset('storage/'.$startup->pitch_deck) }}@endif" type="video/mp4">
    ...
    <div class="card shadow-lg mb-4">
        <div class="card-body">
            ...
            <h5 class="card-title text-center font-weight-bold">
                ...
                <span class="badge badge-warning ml-2" style="font-size:14px;">Faltam {{$rodada->tempo_restante}} Dias</span>
            ...
            <div class="text-center mb-3">
                ...
                <h5 class="text-success">{{number_format($rodada->valor_minimo_investimento,2,',','.')}} AOA</h5>
            </div>
            <div class="text-center mb-3">
            ...
            <div class="d-flex justify-content-center">
                <button data-toggle="modal" data-target="#modal-investir" id="btn-participar-rodada" 
            ...
            <div class="text-center mb-3">
                ...
                <h5 class="text-success">{{number_format($participanteNaRodada->valor_investido,2,",",".")}} AOA</h5>
            </div>
            @endif
