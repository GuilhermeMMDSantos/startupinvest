<div id="step-3" class="step">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="taxa_retencao_clientes" name="taxa_retencao_clientes" required>
    </div>
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="crescimento_base_clientes"
            name="crescimento_base_clientes" required>
    </div>
    <div class="form-group">
        <label for="ciclo_vida_cliente">Qual é o ciclo de vida médio de um cliente(%)?</label>
        <input type="number" step="0.01" class="form-control" id="ciclo_vida_cliente" name="ciclo_vida_cliente" required>
    </div>
    <div class="form-group">
