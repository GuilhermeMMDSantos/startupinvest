<div id="step-3" class="step">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="taxa_retencao_clientes" name="taxa_retencao_clientes">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" step="0.01" class="form-control" id="ciclo_vida_cliente" name="ciclo_vida_cliente">
    </div>
    <div class="form-group">
        <label for="taxa_adocao_inicial">Qual é a taxa de adoção inicial(%)?</label>
        <input type="number" step="0.01" class="form-control" id="taxa_adocao_inicial" name="taxa_adocao_inicial">
    </div>
    <div class="form-group">
