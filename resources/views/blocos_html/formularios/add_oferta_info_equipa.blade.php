<div id="step-6" class="step">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="tamanho_equipe" name="tamanho_equipe">
    </div>
    <div class="form-group">
        <label for="qtd_tecnico">Quantos técnicos a equipe possui?</label>
        <input type="number" class="form-control" id="qtd_tecnico" name="qtd_tecnico">
    </div>
    <div class="form-group">
        <label for="qtd_licenciados">Quantos licenciados a equipe possui?</label>
        <input type="number" class="form-control" id="qtd_licenciados" name="qtd_licenciados">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <label for="qtd_exp_contabilidade">Quantos membros da equipe têm experiência em
            contabilidade?</label>
        <input type="number" class="form-control" id="qtd_exp_contabilidade" name="qtd_exp_contabilidade">
    </div>

    <div class="form-group">
        <label for="qtd_exp_tecnica">Quantos membros da equipe têm experiência técnica?</label>
        <input type="number" class="form-control" id="qtd_exp_tecnica" name="qtd_exp_tecnica">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="tempo_trabalho_juntos" name="tempo_trabalho_juntos">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" class="form-control" id="porcentagem_tempo_projeto" name="porcentagem_tempo_projeto"
            value="">
    </div>
    <div class="form-group">
